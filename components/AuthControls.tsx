...
export function AuthControls({ clientId, onAuthChange }: AuthControlsProps) {
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(31,42,44,0.28)] px-4">
          <div className="glass-card w-full max-w-md rounded-[28px] px-5 py-5 sm:px-6">
